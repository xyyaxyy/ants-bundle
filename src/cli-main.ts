...
export async function main(options: Options = {}) {
  ...
  cli
    ...
    .option('--keep-names', 'Keep original function and class names in minified code')
    ...
    .option('--killSignal <signal>', 'Signal to kill child process, "SIGTERM" or "SIGKILL"')
